...
$layout['object']['default']['top'][] = array( 'name' => 'Title',      'callback' => 'renderObjectTitle');
$layout['object']['default']['left'][] = array( 'name' => 'Summary',   'callback' => 'renderObjectSummaryPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'Comment',   'callback' => 'renderObjectCommentPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'Log',       'callback' => 'renderObjectLogPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'Files',     'callback' => 'renderObjectFilesPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'Ports',     'callback' => 'renderObjectPortsPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'IPAddress', 'callback' => 'renderObjectIPAddressPortlet');
$layout['object']['default']['left'][] = array( 'name' => 'Nat4',      'callback' => 'renderObjectNat4Portlet');
$layout['object']['default']['left'][] = array( 'name' => 'SLB2',      'callback' => 'renderSLBTriplets2');
$layout['object']['default']['left'][] = array( 'name' => 'SLB',       'callback' => 'renderSLBTriplets');
$layout['object']['default']['right'][] = array( 'name' => 'Rack',     'callback' => 'renderObjectRackspacePortlet');
